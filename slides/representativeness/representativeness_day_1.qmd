...
Data Representativeness in Modelling

[*Break*]{style="color: mauve"}
...
::: notes
Conceptual understanding data generating process
Representativeness and comparability
Data representativeness and modelling/inference
:::

## Assessment and Estimation Procedure
...
::: {.column #vcenter width="50%" .r-fit-text }
 * CRR somewhat generally worded on a specific aspect only
 * CDR 439 article 37 introduces specific terms & dimensions
   - *comparability*
   - *risk characteristics*
   - *underwriting/recovery standards*
   - *default definition*
   - *external data*
 * EBA/GL/2017/16 sets out required assessments more comprehensively
   - 4.2.3 Representativeness of data for
model development
:::
 ...
 * CDR 439 articles 42 introduces specific dimensions (focused on PD)
 * EBA/GL/2017/16 sets out required assessments  more comprehensively
