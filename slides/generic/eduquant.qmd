...
::: {.column width="50%" .r-fit-text}
Longer discussion of the question, text auto-fit. 
...
::: {.column width="50%" .r-fit-text }
```{=html}
<iframe class="qp_iframe" src="https://poll-maker.com/frame4435386x512A084F-139" seamless="seamless" frameborder="no" style="border:0; background:transparent; width:100%; height:540px;"></iframe>
```
:::
::::
